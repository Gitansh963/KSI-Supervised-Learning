...
# model1 = joblib.load('pipeline_svc.pkl')
# model2 = joblib.load('pipeline_rf.pkl')
# model3 = joblib.load('pipeline_nn.pkl')
# model4 = joblib.load('pipeline_log.pkl')
# model5 = joblib.load('pipeline_nb.pkl')

# model1 = joblib.load('final_svc.pkl')
model1 = joblib.load('final_svc_smote.pkl')
